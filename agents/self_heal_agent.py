...
def propose_fix(triage_result: Dict[str, Any], evidence_summary: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    recommendation = {
        ...
        "top_fallbacks": evidence_summary.get("top_fallbacks") if evidence_summary else None,
    }
    if confidence is not None and confidence < 0.6:
        recommendation["action"] = "NEEDS_MORE_EVIDENCE"
        recommendation["reason"] = "Selector drift detected, but evidence confidence is low."
